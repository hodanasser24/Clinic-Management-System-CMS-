  ...
  return (
    <div className="prescription-page">
      ...
      <div className="prescription-actions">
        <button onClick={() => alert("Sending prescription to printer...")}>Print</button>

        <button onClick={() => alert("Downloading prescription PDF...")}>Download PDF</button>

        <button className="success" onClick={() => alert("Prescription saved successfully.")}>Save Prescription</button>
      </div>
    </div>
  );
}
