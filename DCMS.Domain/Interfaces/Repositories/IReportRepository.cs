...
{
    Task<PagedResult<Report>> GetByPatientAsync(int patientId, int page, int pageSize, int? doctorId = null, CancellationToken ct = default);
    ...
    Task<PagedResult<Report>> GetByPatientWithDetailsAsync(int patientId, int page, int pageSize, int? doctorId = null, CancellationToken ct = default);
